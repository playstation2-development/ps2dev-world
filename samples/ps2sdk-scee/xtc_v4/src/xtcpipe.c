...
{
/* DUMMY */
	mdmaCnt(xtcState.list, 4, STCYCL(4,4), UNPACK(V4_32, 4, vuLight));
	mdmaAddF(xtcState.list, 32.0f, 32.0f, 32.0f, *(float*)&lightTypeAmbient);
	mdmaAddF(xtcState.list, 128.0f, 128.0f, 128.0f, *(float*)&lightTypeDirect);
float ldir[3] = { 1.0f, 1.0f, -1.0f };
normalize(ldir, ldir);
	mdmaAddF(xtcState.list, ldir[0], ldir[1], ldir[2], 0.0f);
