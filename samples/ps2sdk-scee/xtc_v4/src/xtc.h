...
typedef struct xtcrBuffer xtcrBuffer;
struct xtcrBuffer
{
...
typedef struct xtcRaster xtcRaster;
struct xtcRaster
{
	int32 width;
	int32 height;
...
typedef struct xtcpVertAttrib xtcpVertAttrib;
...
typedef struct xtcpBatchDesc xtcpBatchDesc;
...
typedef struct xtcMicrocodeSwitch xtcMicrocodeSwitch;
struct xtcMicrocodeSwitch
{
        uint32 process, buf1, buf2, buf3;
};

typedef struct xtcMicrocode xtcMicrocode;
struct xtcMicrocode
{
	void *code;
	uint32 vertexTop;
...
typedef struct xtcBatchInfo xtcBatchInfo;
struct xtcBatchInfo
{
	uint32 numBatches;
	uint32 batchSize;
...
typedef struct xtcImState xtcImState;
struct xtcImState
{
	float xyzw[4];
	float stq[4];
